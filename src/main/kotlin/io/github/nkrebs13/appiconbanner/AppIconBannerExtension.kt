...
open class AppIconBannerExtension {
    ...
    /**
     * Path to the Android `res/` directory, relative to the module root. Leave null to
     * auto-detect: the plugin checks `src/androidMain/res` (Compose Multiplatform convention)
     * then falls back to `src/main/res` (traditional Android / KMM convention).
     */
    var androidResDir: String? = null

    /**
     * Base name of the Android launcher icon files. Defaults to `ic_launcher`, which is the
     * name generated by Android Studio's Image Asset Studio. Change this only if your project
